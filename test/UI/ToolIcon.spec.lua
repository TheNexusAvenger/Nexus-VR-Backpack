...
return function()
    ...
    describe("ToolIcon with a tool with no icon", function()
        ...
        it("should change when focused", function()
            ...
            expect(TestToolIcon.Background.Size).to.equal(UDim2.new(1.05, 0, 1.05, 0))
            TestToolIcon.TweenService.shouldHaveSet(Color3.new(0.2, 0.2, 0.2), UDim2.new(1.05, 0, 1.05, 0), 0.5)
        end)
        ...
        it("should become green when equipped", function()
            ...
            expect(TestToolIcon.Background.Size).to.equal(UDim2.new(1.05, 0, 1.05, 0))
            TestToolIcon.TweenService.shouldHaveSet(Color3.new(0.2, 1, 0.2), UDim2.new(1.05, 0, 1.05, 0), 0.5)
        end)
